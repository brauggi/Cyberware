...
public class LibConstants
{
	...
	public static final int CYBEREYES_CONSUMPTION = 0;
	...
	public static final int REPLACEMENTS_CONSUMPTION = 2;
	public static final int REFLEXES_CONSUMPTION = 2;
	public static final int ADRENALINE_CONSUMPTION = 150;
	public static final int SOLAR_PRODUCTION = 5;
	public static final int CONTEXTUALIZER_CONSUMPTION = 0;
	public static final int DEFIBRILLATOR_CONSUMPTION = 500;
	public static final int HEART_CONSUMPTION = 2;
	public static final int STEMCELL_CONSUMPTION = 2;
	public static final int PLATELET_CONSUMPTION = 2;
	public static final int MATRIX_CONSUMPTION = 2;
	public static final int RADIO_CONSUMPTION = 5;
	public static final int HYPEROXYGENATION_CONSUMPTION = 2;
	public static final int AQUA_CONSUMPTION = 0;
	public static final int JUMPBOOST_CONSUMPTION = 0;
	public static final int IMMUNO_CONSUMPTION = 2;
	public static final float DODGE_ARMOR = .70F;
	public static final float DODGE_NO_ARMOR = .65F;
	public static final int LIMB_CONSUMPTION = 0;
	...
	public static final float BEACON_CHANCE_INTERNAL = 10F;
	public static final float BEACON_CHANCE = 20F;
	public static final float LARGE_BEACON_CHANCE = 40F;
	public static final float BEACON_BRUTE_CHANCE = 50F;

	public static final float NATURAL_BRUTE_CHANCE = 20F;
